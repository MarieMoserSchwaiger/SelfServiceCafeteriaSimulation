...
public class SelfServiceModel extends Model {
    ...
    protected int employeesPerStation = 1;

    protected int NUM_DRINKSMACHINES = 1;

    protected int NUM_DININGHALLCAPACITY = 30;
    ...
    public String description() {
        return "This model describes a self service cafe. " +
                    "On arrival 40% of the customers will enter the queue for the sandwich bar. " +
                    "The rest will enter the queue for the menu bar. " +
                    "After that 90% will go to the self-service drinks bar. " +
